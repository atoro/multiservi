  ...
  <table width="950" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="484" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="317" height="35" valign="middle"><img src="imagenes/linea.png" width="317" height="1"></td>
          <td width="316" align="center" valign="middle" class="texto_contactanos">Nuestros Servicios</td>
          <td width="317" valign="middle"><img src="imagenes/linea.png" width="317" height="1"></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <table width="950" height="430" border="0" cellpadding="0" cellspacing="0">
          <?php
		...
		?>
            <tr>
              <td width="317" height="430" align="left" valign="top"><table width="299" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="360" valign="top"><img src="imagenes/servicios/<?php echo $rs["id"]; ?>.jpg" width="299" height="360"></td>
                </tr>
                <tr>
                  <td height="34" align="center" bgcolor="#385BA3" class="texto_pie"><?php echo str_replace("\r\n","<br>",$rs["titulo"]);  ?> <a href="detalleservicios.php?id=<?php echo $rs["id"]; ?>" class="texto_pie">(revisar)</a></td>
                </tr>
              </table></td>
