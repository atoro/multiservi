...
<div id="aside">
  <table width="950" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="253" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="26" align="center" valign="top" class="texto_contactanos">&nbsp;</td>
        </tr>
        <tr>
          <td height="205" valign="top"><table width="949" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="70" height="115" valign="top"><img src="imagenes/dest1.png" width="70" height="70"></td>
              <td width="18">&nbsp;</td>
              <td width="861" valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="27" valign="top" class="texto_titulo"><?php echo $titulo; ?></td>
                  </tr>
                <tr>
                  <td valign="top"><p class="texto_destacado"><?php echo $descripcion; ?></p></td>
                </tr>
                </table></td>
              </tr>
