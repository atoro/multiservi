          ...
          <td height="368" valign="top"><table width="949" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="861" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="27" valign="top" class="texto_titulo"><?php echo $descripcion; ?></td>
                  </tr>
                <tr>
                    ...
                    <tr>
                      <td width="450" height="400" valign="top" class="text5"><form name="form1" method="post" action="contacto.php">
                        <table width="53%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="20" align="left" class="productos">&nbsp;</td>
                          </tr>
                          <tr>
                            <td width="451" align="left"><table width="70" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td height="22" align="center" bgcolor="#165BA7" class="texto_pie"><a href="contacto.php" class="texto_pie">volver</a></td>
                              </tr>
                            </table></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td height="20" align="left" class="texto_b">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="left">&nbsp;</td>
                          </tr>
