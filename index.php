...
<div id="aside">
  <table width="950" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="190" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="26" colspan="3" align="center" valign="top" class="texto_contactanos">&nbsp;</td>
        </tr>
        <tr>
          <td width="317" height="137" valign="top"><table width="317" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="70" height="117" valign="top"><img src="imagenes/dest1.png" width="70" height="70"></td>
              <td width="18">&nbsp;</td>
              <td width="229" valign="top"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="27" valign="top" class="texto_titulo"><?php echo $nosotros; ?></td>
                </tr>
                <tr>
                  <td valign="top"><p class="texto_destacado"><?php echo $contenido1; ?></p></td>
                </tr>
                <tr>
                  <td valign="top">&nbsp;</td>
                </tr>
                <tr>
                  <td valign="top"><table width="70" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="22" align="center" bgcolor="#165BA7" class="texto_pie"><a href="nosotros.php" class="texto_pie">revisar</a></td>
                    </tr>
                  </table>                    <p class="texto_destacado">&nbsp;</p></td>
                </tr>
              </table></td>
            </tr>
          </table></td>
          <td width="316" valign="top"><table width="317" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="70" height="117" valign="top"><img src="imagenes/dest2.png" width="70" height="70"></td>
              <td width="18">&nbsp;</td>
              <td width="229" valign="top"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="27" valign="top" class="texto_titulo"><?php echo $servicios; ?></td>
                </tr>
                <tr>
                  <td height="42" valign="top"><p class="texto_destacado"><?php echo $contenido2; ?></p></td>
                </tr>
                <tr>
                  <td valign="top">&nbsp;</td>
                </tr>
                <tr>
                  <td valign="top"><table width="70" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="22" align="center" bgcolor="#165BA7" class="texto_pie"><a href="servicios.php" class="texto_pie">revisar</a></td>
                    </tr>
                  </table>
                    <p class="texto_destacado">&nbsp;</p></td>
                </tr>
              </table></td>
            </tr>
          </table></td>
          <td width="317" valign="top"><table width="317" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="70" height="117" valign="top"><img src="imagenes/dest3.png" width="70" height="70"></td>
              <td width="18">&nbsp;</td>
              <td width="229" valign="top"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="27" valign="top" class="texto_titulo"><?php echo $contacto; ?></td>
                </tr>
                <tr>
                  <td height="42" valign="top"><p class="texto_destacado"><?php echo $contenido3; ?></p></td>
                </tr>
                <tr>
                  <td valign="top">&nbsp;</td>
                </tr>
                <tr>
                  <td valign="top"><table width="70" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="22" align="center" bgcolor="#165BA7" class="texto_pie"><a href="contacto.php" class="texto_pie">revisar</a></td>
                    </tr>
                  </table>
                    <p class="texto_destacado">&nbsp;</p></td>
                </tr>
