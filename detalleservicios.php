    ...
    <tr>
      <td height="484" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="316" align="center" valign="middle" class="texto_contactanos">Servicios </td>
        ...
        <tr>
          <td width="317" valign="top"><table width="299" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="34" align="center" bgcolor="#385BA3" class="texto_pie"><?php echo $titulo; ?></td>
            </tr>
          </table></td>
          <td colspan="2" align="left" valign="top" class="texto_destacado"><?php echo $completa; ?></td>
          </tr>
      </table></td>
    </tr>
  </table>
